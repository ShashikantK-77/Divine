...
// const navItems = ['Home', 'Accesssories', 'Flowers', 'Ghungroo', 'Hair', 'Hair Rings', 'Kunjalam',
//                    'Nattuvangam','Ornaments','Belts' ];
// const navItemsLinks = ['/', '/about', '/services', '/solutions', '/blogs', '/career', '/buildwithus'];
