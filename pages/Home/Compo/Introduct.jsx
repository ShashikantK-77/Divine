...
const Introduct = () => {
  ...
  <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center ">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-600" data-aos="fade-left" data-aos-easing="ease-in-back" data-aos-delay="500">Indian Dance Costumes
